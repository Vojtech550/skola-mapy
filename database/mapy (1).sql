...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Stř 17. lis 2021, 17:53
...
CREATE TABLE `mesto` (
  `id` int(11) NOT NULL,
  `nazev_mesto` varchar(255) COLLATE utf8_czech_ci NOT NULL
...
INSERT INTO `mesto` (`id`, `nazev_mesto`) VALUES
(83, '22'),
(84, '22'),
(78, '222'),
(42, 'Babice'),
...
CREATE TABLE `obor` (
  `id` int(11) NOT NULL,
  `nazev_obor` varchar(255) COLLATE utf8_czech_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
INSERT INTO `obor` (`id`, `nazev_obor`) VALUES
(2, 'IT'),
(1, 'OA');
...
(86, 'ZŠ nad Lipnouus', 5, 40.139728, 37.139728),
(87, 'HAHHAAHHAHA', 0, 2323, 232),
(88, 'aass', 7, 23.434, 33.223),
(89, 'ZŠ Uhelná', 42, 0, 0),
(90, 'LALA', 43, 11, 11);
...
(1, '127.0.0.1', 'administrator', '$2y$12$7i2q2l0UTivOFJKjZ1FFCOgJ1MxfgFzxZN3tBKd18ieqZrY.zs6Qy', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1637162098, 1, 'Admin', 'istrator', 'ADMIN', '0'),
(2, '::1', 'sss@gmail.com', '$2y$10$c2nLwW0zuL8EXVflpziSgOH/oq2pHZSownZijiz4wclo4v2qyT/ou', 'sss@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1636585573, NULL, 1, 'Lask', 'Kask', 'Asaka', '343222333');
...
ALTER TABLE `obor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nazev` (`nazev_obor`);

--
-- Indexy pro tabulku `pocet_prijatych`
--
...
--
-- Indexy pro tabulku `zpetna_vazba`
--
